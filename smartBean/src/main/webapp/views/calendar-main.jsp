	...
	<div id='external-events'>
		...
		<div id="create-calendar-popup" style="display: none;">
			<form method="post" action="CreateCalendar" id="create-calendar-form">
				<input type="text" id="create-calendar-popup" name="calendarName"
					placeholder="new calendar title"><br> <input
					type="text" id="newCalendar-owner-input" name="owner"
					value="${sessionScope.log}" placeholder="calendar owner"><br>
		...
		<div id="admin-newCalendar-popup" style="display: none;">
			<div class="button-container">
				...
				<button id="close-newCalendar-button" type="button">
					<img class="close-icon" src="../resources/img/closeIcon.png"
						alt="Close Icon">
				</button>
			</div>
			...
			<form method="post" id="update-calendar-form">
				<p>캘린더 이름 변경</p>
		...
		<form method="post" action="CreateTask" id="create-task-form">
			<div id="add-task-popup" style="display: none;">
				<input type="text" id="task-name-input" name="name"
					placeholder="task title 입력">
		...
		<div id="admin-task-popup" style="display: none;">
			...
			<button id="delete-task-button">Task 삭제</button>
			<br>
			<p>Task 이름 변경</p>
